...
<%@ page import="com.klef.flemflare.model.SpotEvent" %>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>

<%
    List<SpotEvent> events = (List<SpotEvent>) request.getAttribute("events");
%>
...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4">Upcoming Spot Events</h2>
        
        <% if (events != null && !events.isEmpty()) { 
            for (int i = 0; i < events.size(); i++) { 
                SpotEvent event = events.get(i); 
        %>
