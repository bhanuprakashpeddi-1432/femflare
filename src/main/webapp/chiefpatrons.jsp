...
<head>
    ...
    <title>Chief Patrons        <div class="c        <div class="card">
        ...
        <div class="card">
            ...
            <h3>Hon'ble Vice-President</h3>
            <p>KLEF</p>
        </div>         <img src="images/k_Satayanarayana.jpg" alt="Chief Patron">
            <h2>Sri. Koneru Satyanarayana</h2>
            <h3>Hon'ble President</h3>
            <p>KLEF</p>
        </div>
        <div class="card">
            <img src="images/kanchana.jpg" alt="Chief Patron">
            <h2>Smt. K. Kanchana Latha</h2>
...
<body>
    ...
    <div class="patrons-container">
        <div class="hero-section">
            <h1 class="hero-title">Chief Patrons</h1>
            <p class="hero-subtitle">Leadership & Guidance - FemFlare 2025</p>
        </div>
