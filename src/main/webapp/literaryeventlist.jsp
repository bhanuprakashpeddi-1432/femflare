...
<%@ page import="com.klef.flemflare.model.LiteraryEvent" %>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>

<%
    List<LiteraryEvent> events = (List<LiteraryEvent>) request.getAttribute("events");
%>
...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4">Upcoming Literary Events</h2>
        
        <% if (events != null && !events.isEmpty()) { 
            for (int i = 0; i < events.size(); i++) { 
                LiteraryEvent event = events.get(i); 
        %>
